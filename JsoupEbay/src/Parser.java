...
public class Parser {
	public static void main (String[] args) {
		...
		System.out.println("Please enter the maximum price that you would be willing to pay (just an Double amount).");
		...
		try {
			...
			Elements ship = doc.select("span.ship");
			for (Element number: base) {
				basePrice.add(number.getElementsByTag("span").first().text());
